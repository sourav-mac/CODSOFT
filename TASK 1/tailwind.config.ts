  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        bot: { DEFAULT: "hsl(var(--bot-bubble))", foreground: "hsl(var(--bot-bubble-foreground))" },
        user: { DEFAULT: "hsl(var(--user-bubble))", foreground: "hsl(var(--user-bubble-foreground))" },
      ...
      keyframes: {
        ...
        "typing-dot": { "0%, 60%, 100%": { opacity: "0.3" }, "30%": { opacity: "1" } },
      },
      animation: {
